...
public class StrictlyGreaterThanAttribute : RangeAttribute
{
    internal static class Int64Minimum
    {
        ...
        public static double ToDouble( long min )
        {
            return (double) min + FloatingPointHelper.GetDoubleStep( (double) min );
        }

        public static decimal ToDecimal( long min )
        {
            return (decimal) min + FloatingPointHelper.GetDecimalStep( (decimal) min );
        }
    }
    ...
    public StrictlyGreaterThanAttribute( long min )
        : base( min, long.MaxValue,
                Int64Minimum.ToInt64( min ), long.MaxValue,
                Int64Minimum.ToUInt64( min ), ulong.MaxValue,
                Int64Minimum.ToDouble( min ), double.MaxValue,
                Int64Minimum.ToDecimal( min ), decimal.MaxValue,
    ...
    internal static class UInt64Minimum
    {
        ...
        public static double ToDouble( ulong min )
        {
            return (double) min + FloatingPointHelper.GetDoubleStep( (double) min );
        }
    ...
    public StrictlyGreaterThanAttribute( ulong min )
        : base( min, ulong.MaxValue,
                UInt64Minimum.ToInt64( min ), long.MaxValue,
                UInt64Minimum.ToUInt64( min ), ulong.MaxValue,
                UInt64Minimum.ToDouble( min ), double.MaxValue,
                UInt64Minimum.ToDecimal( min ), decimal.MaxValue,
    ...
    internal static class DoubleMinimum
    {
        ...
        public static double ToDouble( double min )
        {
            ...
            double step = FloatingPointHelper.GetDoubleStep( min );
        ...
        public static decimal ToDecimal( double min )
        {
            ...
            decimal step = FloatingPointHelper.GetDecimalStep( (decimal) min );
    ...
    public StrictlyGreaterThanAttribute( double min )
        : base( min, double.MaxValue,
                ...
                DoubleMinimum.ToDouble( min ), double.MaxValue,
    ...
    protected override (IExpression MessageIdExpression, bool IncludeMinValue, bool IncludeMaxValue) GetExceptioninfo()
        => (CompileTimeHelpers.GetContractLocalizedTextProviderField( nameof( ContractLocalizedTextProvider.StrictlyGreaterThanErrorMessage ) ),
            true, false);
}
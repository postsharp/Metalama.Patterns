...
public class StrictRangeAttribute : RangeAttribute
{
    ...
    public StrictRangeAttribute( long min, long max )
        : base( RangeBound.Create( min, true ), RangeBound.Create( max, true ) ) { }
    ...
    {
        meta.Target.GetContractOptions().Templates!.OnStrictRangeContractViolated( value, this.Range.MinValue.ObjectValue, this.Range.MaxValue.ObjectValue );
    }
}
...
public static class ClassicImplementationStrategyExtensions
{
    ...
    /// <summary>
    /// Configures <c>Metalama.Patterns.Observability.Implementation.ClassicStrategy</c> for the current namespace.
    /// </summary>
    ...
    /// <summary>
    /// Configures <c>Metalama.Patterns.Observability.Implementation.ClassicStrategy</c> for the current type.
    /// </summary>

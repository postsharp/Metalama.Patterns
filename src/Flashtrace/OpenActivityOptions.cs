...
namespace PostSharp.Patterns.Diagnostics
{
    ...
    public struct OpenActivityOptions
    {
        ...
        internal bool IsHidden
        {
            ...
            set
            {
                Flags otherFlags = this.flags & ~Flags.IsHidden;
                Flags thisFlag = value ? Flags.IsHidden : Flags.Default;
        ...
        {
            readonly get => new IncomingRequestOptions( (this.flags & Flags.IsParentSampled) != 0 );

            set
            {
                Flags otherFlags = this.flags & ~Flags.IsParentSampled;
                Flags thisFlag = value.IsParentSampled ? Flags.IsParentSampled : Flags.Default;
                this.flags = otherFlags | thisFlag;
            }
        }
        ...
        public bool IsSyntheticRootId
        {
            ...
            set
            {
                Flags otherFlags = this.flags & ~Flags.IsRoot;
                Flags thisFlag = value ? Flags.IsRoot : Flags.Default;
                this.flags = otherFlags | thisFlag;  
            }
        }

...
public interface ICachingConfigurationAttribute
{
    ...
    /// </summary>
    double AbsoluteExpiration { get; init; }
    ...
    /// </summary>
    double SlidingExpiration { get; init; }

    /// <summary>
    /// Gets or sets the priority of the cached method.
    /// </summary>
    CacheItemPriority Priority { get; init; }
    ...
    /// </summary>
    bool IgnoreThisParameter { get; init; }

    bool UseDependencyInjection { get; init; }
}
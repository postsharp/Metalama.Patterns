...
/// <summary>
/// Custom attribute that indicates that the target element (or its contained members, when applicable) is safe to call and for which no dependency analysis is required.
/// </summary>
[PublicAPI]
...
public sealed class SafeToCallForDependencyAnalysisAttribute : Attribute, IHierarchicalOptionsProvider
{

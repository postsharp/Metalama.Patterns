...
/// </summary>
[CompileTime] 
internal sealed class Node : CommonProcessingNode<Node>, IReadOnlyNode { }

[CompileTime]
internal class CommonProcessingNode<TDerived, TReadOnlyDerivedInterface> : IReadOnlyNode<TReadOnlyDerivedInterface>
    where TDerived : CommonProcessingNode<TDerived, TReadOnlyDerivedInterface>, TReadOnlyDerivedInterface, new()
    where TReadOnlyDerivedInterface : IReadOnlyNode<TReadOnlyDerivedInterface>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="CommonProcessingNode{TDerived, TReadOnlyDerivedInterface}"/> class which represents the root node of a tree.
    /// </summary>
    protected CommonProcessingNode() { }

...
public class FormatterOverwritingTest : FormattersTestsBase
{
    ...
    public record TestCase( string Description, Type TValue, Type OldFormatterTargetType, Type OldFormatterType, Type NewFormatterTargetType, Type NewFormatterType )
    {
    ...
    public void EnsureOverwrites( string testCase, bool logBefore, bool logBetween )
    {
        ...
        typeof( FormatterOverwritingTest ).GetMethod( nameof( this.EnsureOverwritesCore ), BindingFlags.Instance | BindingFlags.NonPublic ).MakeGenericMethod( testCaseRecord.TValue )
            .Invoke(
                this,
                new object[]
                {
    ...
    public static IEnumerable<TestCase> EnsureDoesntOverwriteTestCases() => new TestCase[] {
        // generic interface -> object
        new(
            "generic interface -> object", typeof( int[] ),
            typeof( IEnumerable<> ), typeof( ZeroEnumerableFormatter<> ),
            typeof( object ), typeof( OneFormatter<object> ) ),

        // generic interface -> generic interface (worse)
        new(
            "generic interface -> generic interface (worse)", typeof( int[] ),
            typeof( ICollection<> ), typeof( ZeroEnumerableFormatter<> ),
            typeof( IEnumerable<> ), typeof( OneEnumerableFormatter<> ) ),

        // generic base type -> generic interface (worse)
        new(
            "generic base type -> generic interface (worse)", typeof(ObservableCollection<int> ),
            typeof( Collection<> ), typeof( ZeroEnumerableFormatter<> ),
            typeof( IEnumerable<> ), typeof( OneEnumerableFormatter<> ) ),

        // generic base type -> generic base type (worse)
        new(
            "generic base type -> generic base type (worse)", typeof(MyObservableCollection<int>),
            typeof( ObservableCollection<> ), typeof( ZeroEnumerableFormatter<> ),
            typeof( Collection<> ), typeof( OneEnumerableFormatter<> ) ),

        // generic exact type -> generic base type
        new(
            "generic exact type -> generic base type", typeof(ObservableCollection<int> ),
            typeof( ObservableCollection<> ), typeof( ZeroEnumerableFormatter<> ),
            typeof( Collection<> ), typeof( OneEnumerableFormatter<> ) ),

        // generic exact type -> interface
        new(
            "generic exact type -> interface", typeof(ObservableCollection<int> ),
            typeof( ObservableCollection<> ), typeof( ZeroEnumerableFormatter<> ),
            typeof( IEnumerable<int> ), typeof( OneEnumerableFormatter<int> ) ),

        // interface -> interface (worse)
        new(
            "interface -> interface (worse)", typeof(ObservableCollection<int> ),
            typeof( ICollection<int> ), typeof( ZeroEnumerableFormatter<int> ),
            typeof( IEnumerable<int> ), typeof( OneEnumerableFormatter<int> ) ),

        // base type -> interface (worse)
        new(
            "base type -> interface (worse)", typeof(ObservableCollection<int> ),
            typeof( Collection<int> ), typeof( ZeroEnumerableFormatter<int> ),
            typeof( IEnumerable<int> ), typeof( OneEnumerableFormatter<int> ) ),

        // base type -> base type (worse)
        new(
            "base type -> base type (worse)",typeof(MyObservableCollection<int>),
            typeof( ObservableCollection<int> ), typeof( ZeroEnumerableFormatter<int> ),
            typeof( Collection<int> ), typeof( OneEnumerableFormatter<int> ) ),

        // exact type -> base type
        new(
            "exact type -> base type", typeof(ObservableCollection<int> ),
            typeof( ObservableCollection<int> ), typeof( ZeroEnumerableFormatter<int> ),
            typeof( Collection<int> ), typeof( OneEnumerableFormatter<int> ) ),

        // Array (generic base type) -> Array (base type)
        new(
            "Array (generic base type) -> Array (base type)",typeof( int[] ),
            typeof( Array ), typeof( ZeroEnumerableFormatter<> ),
            typeof( Array ), typeof( OneFormatter<Array> ) )
    };

    public static IEnumerable<object[]> EnsureDoesntOverwritesSerializablePermutations() => MakeSerializableBeforeBetweenPermutations( EnsureDoesntOverwriteTestCases() );
    ...
    public void EnsureDoesntOverwrite( string testCase, bool logBefore, bool logBetween )
    {
        ...
        typeof( FormatterOverwritingTest ).GetMethod( nameof( this.EnsureDoesntOverwriteCore ), BindingFlags.Instance | BindingFlags.NonPublic ).MakeGenericMethod( testCaseRecord.TValue )
            .Invoke(
                this,
                new object[]
                {

...
internal sealed class DelegateGraphBuildingContext : IGraphBuildingContext
{
    ...
    /// </summary>
    /// <param name="isConfiguredAsSafe">If <see langword="null"/>, <see cref="IGraphBuildingContext.MustIgnoreUnsupportedDependencies"/> will always return <see langword="false"/>.</param>
    /// <param name="reportDiagnostic"></param>
    /// <param name="treatAsImplementingInpc">If <see langword="null"/>, <see cref="IGraphBuildingContext.TreatAsImplementingInpc(ITypeSymbol)"/> will always return <see langword="false"/>.</param>
    /// <param name="isAutoPropertyOrField">If <see langword="null"/>, <see cref="IGraphBuildingContext.IsAutoPropertyOrField(ISymbol)"/> will return <see langword="true"/> for any field or property.</param>
    ...
    public bool MustIgnoreUnsupportedDependencies( ISymbol symbol ) => this._isConfiguredAsSafe?.Invoke( symbol ) ?? false;

...
namespace PostSharp.Patterns.Caching.Tests.Backends.Distributed
{
    internal static class RedisFactory
    {
        ...
        public static DisposingRedisCachingBackend CreateBackend( TestContext testContext, string prefix = null, bool supportsDependencies = false,
                                                                  bool locallyCached = false )
        {
            RedisTestInstance redisTestInstance = CreateTestInstance( testContext );
        ...
        public static async Task<DisposingRedisCachingBackend> CreateBackendAsync( TestContext testContext, string prefix = null,
                                                                                   bool supportsDependencies = false, bool locallyCached = false )
        {
            RedisTestInstance redisTestInstance = null;
    ...
    class DisposingConnectionMultiplexer : IConnectionMultiplexer, IDisposable
    {
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        bool IConnectionMultiplexer.IncludeDetailInExceptions { get => this.inner.IncludeDetailInExceptions; set => this.inner.IncludeDetailInExceptions = value; }
    ...
    /// </summary>
    class DisposingRedisCachingBackend : CachingBackendEnhancer
    {
        private readonly IDisposable[] disposables;

...
{
  private global::Metalama.Patterns.NotifyPropertyChanged.AspectTests.FieldBackedInpcProperty.A _x1 = default !;
  private global::Metalama.Patterns.NotifyPropertyChanged.AspectTests.FieldBackedInpcProperty.A _x
  {
    get
    {
      return this._x1;
  ...
  private void SubscribeTo_x(global::Metalama.Patterns.NotifyPropertyChanged.AspectTests.FieldBackedInpcProperty.A value)
  {
    if (value != null)
    {
